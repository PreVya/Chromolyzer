...
def assign_weights_linearly(color):
    color_order = ['Green', 'Blue', 'Purple', 'Pink','Red', 'Orange', 'Yellow']
...
def weights_cal(u1,u2,u3):
    ...
    print(wts)
    emp_per=calculate_deci_making(wts)
    if emp_per > 97:
...
#main
scoring_dict = {
    'Ques1': {'Red': 3, 'Orange': 2, 'Yellow':1, 'Green':7, 'Blue': 6, 'Purple':5,'Pink': 4},
    'Ques2': {'Red': 3, 'Orange': 2, 'Yellow':1, 'Green':7, 'Blue': 6, 'Purple':5,'Pink': 4},
    'Ques3': {'Red': 3, 'Orange': 2, 'Yellow':1, 'Green':7, 'Blue': 6, 'Purple':5,'Pink': 4}
} 
ques_wt={
    'Ques1':3,
    'Ques2':2,
