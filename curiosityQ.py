#FOR QUESTION SET 13-15
import random

def assign_weights_linearly(color):
    color_order = ['Orange', 'Yellow','Green','Blue', 'Purple','Pink','Red']
...
def weights_cal(u1,u2,u3):
    ...
    print(wts)
    emp_per=calculate_curiosity_quotient(wts)
    if emp_per > 97:
...
def calculate_curiosity_quotient(wts):
    emp_per=[]
    for i in range(3):
        tpl=wts[i]
        hue_weight=tpl[0]
...
#main
scoring_dict = {
    'Ques1': {'Red': 1, 'Orange': 7, 'Yellow':6, 'Green':5, 'Blue': 4, 'Purple':3,'Pink': 2},
    'Ques2': {'Red': 1, 'Orange': 7, 'Yellow':6, 'Green':5, 'Blue': 4, 'Purple':3,'Pink': 2},
    'Ques3': {'Red': 1, 'Orange': 7, 'Yellow':6, 'Green':5, 'Blue': 4, 'Purple':3,'Pink': 2}
} 
ques_wt={
    'Ques1':2,
    'Ques2':1,
