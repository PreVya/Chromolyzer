#FOR QUESTION SET 10-12
import random

def assign_weights_linearly(color):
    color_order = ['Pink','Red', 'Orange', 'Yellow','Green','Blue', 'Purple']
...
def weights_cal(u1,u2,u3):
    ...
    print(wts)
    emp_per=calculate_social_wellB(wts)
    if emp_per > 97:
...
def calculate_social_wellB(wts):
    emp_per=[]
    for i in range(3):
        tpl=wts[i]
        hue_weight=tpl[0]
...
#main
scoring_dict = {
    'Ques1': {'Red': 6, 'Orange': 5, 'Yellow':4, 'Green':3, 'Blue': 2, 'Purple':1,'Pink': 7},
    'Ques2': {'Red': 6, 'Orange': 5, 'Yellow':4, 'Green':3, 'Blue': 2, 'Purple':1,'Pink': 7},
    'Ques3': {'Red': 6, 'Orange': 5, 'Yellow':4, 'Green':3, 'Blue': 2, 'Purple':1,'Pink': 7}
} 
ques_wt={
    'Ques1':2,
    'Ques2':3,
